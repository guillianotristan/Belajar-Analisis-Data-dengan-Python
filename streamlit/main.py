...
all_df = pd.read_csv(dir + "../dataset/all_data.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv(dir + '../dataset/geolocation.csv')
...
with st.sidebar:
    # Title
    st.title("Guilliano Tristan Anthony Stevenson")
...
st.caption('Copyright (C) Guilliano Tristan Anthony Stevenson 2023')
